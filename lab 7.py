...
exam_two = simpledialog.askniteger("Input exam grade two: ", parent=tk.Tk().withdraw())

exam_3 = str(simpledialog.askinteger("Input exam grade three: ", parent=tk.Tk().withdraw()))
